        ...
        <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
            <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl" >
                <div className = "w-3/5 p-5">
                    ...
                    <div onClick={handleSubmit} className="py-10 mb-2">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="bg-gray-100 w-64 p-2 flex items-center mb-3">
                                ...
                                <input type="email" name="email" placeholder="Email" className='bg-gray-100 outline-none text-xs flex-1 m-2'/>
                            </div>
                            <div className="bg-gray-100 w-64 p-2 flex items-center">
                                <MdLockOutline className="text-gray-400 mr-2"/>
                                <input type="password" name="password" placeholder="Password" className='bg-gray-100 outline-none text-xs flex-1 m-2'/>
                            </div>
                            {error && (
                            ...
                            <a href="#" className="border-2 border-indigo-500 text-indigo-500 rounded-full px-12 py-2 inline-block mt-3 font-semibold hover:bg-indigo-500 hover:text-white">Sign In</a>
                        </div>
                    </div>
                </div>{/*sign in section*/}
